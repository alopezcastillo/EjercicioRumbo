...
public final class CsvFiles
{
 ...
 public static String fullPathTo(String fileName)
  {
	  String regexWindowsPath="^/[A-Z]:/.*";//Example: /C:/...
	  String retorno =  CsvFiles.class.getClassLoader().getResource(fileName).getPath();
	  //for problem with windows and .getPath() returned
	  if(retorno.matches(regexWindowsPath))
